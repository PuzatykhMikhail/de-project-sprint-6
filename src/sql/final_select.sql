...
(
  ...
  from STV202310069__DWH.h_groups hg 
...
(
  ...
  from STV202310069__DWH.l_groups_dialogs as lgd 
  left join STV202310069__DWH.l_user_message as lum on lum.hk_message_id = lgd.hk_message_id 
